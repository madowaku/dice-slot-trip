"""Normalize the ImageGen trail-stone glyph into the T029 white-mask contract."""
...
if __name__ == "__main__":
    if len(sys.argv) != 3:
        raise SystemExit("usage: normalize_v07_tile_icon.py <source-rgba.png> <target.png>")

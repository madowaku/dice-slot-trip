...
func _init() -> void:
	...
	_expect(not bool(unsupported_receipt.supported) and int(unsupported_receipt.visual_count) == 3 and not bool(unsupported_receipt.processing), "district coordinator keeps three fixed visuals and does not update unsupported districts")

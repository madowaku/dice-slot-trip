...
func _init() -> void:
	...
	_expect(oasis_rescue.position == {"route_id":"main","tile_index":23} and oasis_rescue.exited_warp_gate_id == "W1" and oasis_rescue.forced_loop_exit, "third EXIT pass forces the W1 rescue return")
